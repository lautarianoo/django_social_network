...
class SocialUser(AbstractBaseUser):
    ...
    infouser = models.ForeignKey(InfoUser, verbose_name='Информация о юзере', on_delete=models.CASCADE, related_name='user', null=True)
    ...
    friends = models.ManyToManyField('self', verbose_name='Друзья', related_name='user')
    followers = models.ManyToManyField('self', verbose_name='Подписчики', related_name='user')
    subscribers = models.ManyToManyField('self', verbose_name='Подписки', related_name='user')
    ...
    groups = models.ManyToManyField('community.Group', verbose_name='Группы', related_name='user')
